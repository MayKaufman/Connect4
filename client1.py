                ...
                for event in pygame.event.get():
                    ...
                    if my_turn:
                        if event.type == pygame.MOUSEMOTION:
                            ...
                            pygame.draw.circle(screen, RED, (event.pos[0], RADIOS), RADIOS)
                        ...
                        while event.type == pygame.MOUSEBUTTONDOWN and event.button == LEFT and not made_move and not occupied:
                            ...
                            elif answer.split("|")[0] == "OCCUPIED" and not occupied:  # place is occupied
                                occupied = True
                        ...
                        if not got_enemy_turn:
                            ...
                            if data[0] == "STOPGAME":
                                ...
                                pygame.draw.circle(screen, YELLOW, (col * (2 * RADIOS + SPACE) + RADIOS, row * (2 * RADIOS + SPACE) + RADIOS), RADIOS)  # not sure about the row!!!!
                                pygame.display.flip()
